  ...
  "2026-08-21": {
    ...
    comments: [
      ...
      },
      {
        ...
        drafts: [
          "Thanks Raunak, taking the second one first since that is what you care about. A reddit or twitter post is not a static object. Upvotes, comment counts, edits and deletions all move through the day, so fetching the same post twice is not a duplicate request, it is two points on a timeline. That is usually the whole reason anyone fetches twice. If we charged you once and quietly served you the morning copy at 6pm, we would be handing you stale data at exactly the moment you asked for fresh, and you would have no way to tell. So yes, a second call is a second collection, because it is genuinely a second observation. On Composio, different layer, they connect agents to apps that already have APIs and we go after the web where one does not exist.",
