  ...
  "2026-08-21": {
    ...
    comments: [
      ...
      },
      {
        ...
        drafts: [
          "Gal, this is exactly what Saurabh was asking for, thank you for answering it properly rather than just naming a site. Review text, star rating and reviewer company size band is a clean spec, and 500 to 1,000 rows a month is a small volume for us. The size band is the smart inclusion, since that is the field that turns a pile of reviews into something you can segment by, and it is usually the first one dropped. You are also right that review sites get treated as second class next to the big platforms, which is strange given how much competitive signal sits in them. [VERDICT: yes we can build G2 and Capterra / doable but not trivial / not one we would take on, pick one and say it plainly] On your pricing question, you pay per collection, so calling the same page twice bills twice. For review tracking I would not run it that way though. Reviews accumulate rather than change, so what you actually want is the new ones, and a scheduled pull with a dedupe on review id at your end gives you the same picture for a fraction of the calls. Tell me whether you need it daily or weekly and I will price it properly for you.",
      ...
      },
      {
        ...
        drafts: [
          "Thanks Oliver, that was exactly the goal. Same request, same response shape, so adding a source is a config change rather than a migration.",
