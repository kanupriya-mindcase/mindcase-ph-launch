    ...
    makers: [
      {
        ...
        drafts: [
          "Kanupriya here, cofounder at Mindcase. A concrete ask for this thread rather than another pitch: which source breaks your pipeline most often, and how did you find out it broke? An alert, a number that looked wrong in a dashboard, or a customer telling you first? I ask because silent failure is the pattern we hear most. Not an error, just fewer rows, noticed days later. Reply with the source and how you caught it, and I will tell you what we do about that specific failure mode and whether we handle it well today. If we do not, I would rather say so here than let you find out after you have wired us in.",
          "Kanupriya here, cofounder. If you are trying to work out whether this is actually cheaper than what you run today, give me three things and I will do the maths in the thread: the sources you pull, roughly how many rows a month, and whether you are paying for infrastructure, for people to maintain it, or both. Our pricing is $0.06 to $20 per 1,000 rows depending on the agent, prepaid, no seats and no minimums, so the comparison is usually simpler than people expect once the maintenance time is counted honestly. I will give you a real number even when that number says stay where you are."
        ]
      },
      {
        id: "maker-kritish",
