window.TEMPLATES = {
  meta: {
    audiences: [
      ["makers","Makers","Fellow founders. Hook: their product and rank."],
      ["hunters","Hunters","Prolific hunters. Hook: their all-time hunt count."],
      ["active","Active people","Top Kitty Points members. Hook: they engage constantly."]
    ],
    phases: [["pre","Pre-launch"],["start","Launch start"],["end","Launch end"]]
  },
  makers: {
    pre: [
    ...
    start: [
      ...
      "[Name], we are in the last stretch: [link]. Thank you if you already looked. If not and you have a moment, I would still love your honest take. Appreciate you regardless.",
      "Hey [Name], closing out our launch day: [link]. Just wanted to say thanks for building [Product], it is good company to launch alongside. A look would be great if you can, no stress.",
      "[Name], a few hours left: [link]. If you have a sec, would still love your eyes on it. And genuinely, congrats on [Product], let me know when you launch next so I can be there.",
      "[Name], wrapping up our launch: [link]. No obligation at all, but your feedback as a fellow maker would mean a lot. Thanks either way, and see you around PH."
    ]
  },
  hunters: {
    pre: [
    ...
    start: [
      ...
      "[Name], we are in the final stretch: [link]. Thanks if you already looked. If you get a moment, your read as someone who has hunted [N] products would be gold. Appreciate you either way.",
      "[Name], last few hours: [link]. Totally understand if it slipped by, but your take would still mean a lot given everything you have hunted. Thank you regardless.",
      "Hey [Name], closing out our launch: [link]. Just wanted to thank you for championing so many products, it is why I reached out. A quick look would be appreciated if you can.",
      "[Name], wrapping up: [link]. If you have a spare minute, I would love your honest read. And genuinely, thanks for being one of the people who makes PH worth launching on.",
      "[Name], final hours: [link]. No obligation at all. If it is up your alley, your support would be an honor, and if not, I appreciate you either way."
    ]
  },
  active: {
    pre: [
    ...
    start: [
      ...
      "[Name], final hours of our launch: [link]. If you have a moment, your feedback would be really valued, your comments are always thoughtful. Thanks for being so active in the community regardless.",
      "[Name], we are wrapping up: [link]. Thanks if you already stopped by. If not, I would still love your honest take. Appreciate all you do here either way.",
      "Hey [Name], last stretch of our launch: [link]. A quick thought from you would mean a lot given how engaged you are. No stress if not.",
      "[Name], closing out today: [link]. If you get a sec, your feedback would be genuinely valuable. Thank you for being one of the most active people on PH.",
      "[Name], final few hours: [link]. No obligation, but I would love your read. Either way, thanks for making the community what it is."
    ]
  }
};
